...
public class Task1test extends TestCase {
    ...
    public static Calculator createCZKtoUSD() {
        ...
        Calculator c = null;
        try {
            c = Calculator.create(Currencies.eUSD, Currencies.eCZK, 17);
        } catch (Exception e) {
    ...
    public static Calculator createSKKtoCZK() {
        ...
        Calculator c = null;
        try {
            c = Calculator.create(Currencies.eSKK, Currencies.eCZK, 0.8);
        } 
        catch (Exception e) {
            System.out.println(e);
        }
    ...
    public void testExchangeSKKCZK() throws Exception {
        ...
        result = c.convert(Currencies.eSKK, Currencies.eCZK, 16);
