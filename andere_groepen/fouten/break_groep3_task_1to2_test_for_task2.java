 ...
 * @author frank
 */
public class break_groep3_task_1to2_test_for_task2 {
    
    public break_groep3_task_1to2_test_for_task2() {
    }
    ...
    public void TestFromDoubleToBigDecimal() throws Exception {
        ...
        Calculator c = CalculatorImpl.create(Currencies.eCZK, Currencies.eSKK, Double.Nan);;
    }
    ...
    public void TestThrownException() throws Exception {
        ...
        Calculator c = CalculatorImpl.create(Currencies.eCZK, Currencies.eSKK, 1.0);
        try {
